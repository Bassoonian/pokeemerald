const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CHARMANDER] = {{EVO_LEVEL, 17, SPECIES_CHARMELEON}},
    ...
    [SPECIES_LEDYBA]     = {{EVO_LEVEL, 10, SPECIES_LEDIAN}},
    [SPECIES_SPINARAK]   = {{EVO_LEVEL, 34, SPECIES_ARIADOS}},
    ...
    [SPECIES_MEDITITE]   = {{EVO_LEVEL, 50, SPECIES_MEDICHAM}},
