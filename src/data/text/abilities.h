...
const u8 gAbilityNames[ABILITIES_COUNT_GEN7][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_TINTED_LENS] = _("Tinted Les"),
    ...
    [ABILITY_REGENERATOR] = _("Regeerator"),
    ...
    [ABILITY_PRIMORDIAL_SEA] = _("PrimordialSe"),
    ...
    [ABILITY_EMERGENCY_EXIT] = _("EmergencyExi"),
    [ABILITY_WATER_COMPACTION] = _("WaterCompact"),
    ...
    [ABILITY_QUEENLY_MAJESTY] = _("QueenlyMajes"),
    ...
    [ABILITY_POWER_OF_ALCHEMY] = _("PowerOfAlche"),
    [ABILITY_BEAST_BOOST] = _("Beast Boost"),
    [ABILITY_RKS_SYSTEM] = _("RKS System"),
    [ABILITY_ELECTRIC_SURGE] = _("ElectricSurg"),
