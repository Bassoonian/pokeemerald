...
static const u8 LandmarkName_PetalburgWoods[] = _("Borago Grove");
static const u8 LandmarkName_MrBrineysCottage[] = _("MR. BRINEY'S COTTAGE");
static const u8 LandmarkName_AbandonedShip[] = _("Parched Ruins");
...
static const u8 LandmarkName_NewMauville[] = _("Miasmic Woods");
...
static const u8 LandmarkName_MeteorFalls[] = _("Candid Cave");
static const u8 LandmarkName_TunnelersRestHouse[] = _("TUNNELER'S RESTHOUSE");
static const u8 LandmarkName_RusturfTunnel[] = _("Pass of Trials");
...
static const u8 LandmarkName_SeafloorCavern[] = _("Cocytus Cavern");
static const u8 LandmarkName_GraniteCave[] = _("Shrub Grotto");
static const u8 LandmarkName_OceanCurrent[] = _("OCEAN CURRENT");
static const u8 LandmarkName_LanettesHouse[] = _("LANETTE'S HOUSE");
static const u8 LandmarkName_FieryPath[] = _("Torrid Hollow");
static const u8 LandmarkName_JaggedPass[] = _("Slope of Sleet");
...
static const u8 LandmarkName_MagmaHideout[] = _("Gratia Forest");
static const u8 LandmarkName_MirageTower[] = _("MIRAGE TOWER");
static const u8 LandmarkName_AlteringCave[] = _("Temporal Weald");
